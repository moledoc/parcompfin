...
prep_data <- function(what){
	...
	data[Parallel!=0,Efficiency_overall:=RSpeedup_overall/(as.integer(Parallel/1000)+Parallel%%1000)]
	data[Parallel!=0,Efficiency_calculation:=RSpeedup_calculation/(as.integer(Parallel/1000)+Parallel%%1000)]
