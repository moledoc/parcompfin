...
double comparison = $(./bin/binom_vanilla_amer ${payoff_fun} ${S0} ${E} ${r} ${sigma} ${T} 1000 | tr ',' '\t' | awk '{print $13}');" > include/comparison.h
  ...
  do
    ...
    do
        ...
        echo "#!/bin/bash
      #SBATCH -J MC_AMER_SERIAL_${payoff_fun}_${S0}_${E}_${r}_${sigma}_${T}_${N}
      #SBATCH -N 1
      ...
      cd $HOME/parcompfin
      make mc_amer_bin
      ./bin/mc_amer ${payoff_fun} ${S0} ${E} ${r} ${sigma} ${T} ${N} ${M} >> ${results}" > parcomfin.sbatch
      ...
      do
        ...
        echo "#!/bin/bash
      #SBATCH -J MC_AMER_OMP_${payoff_fun}_${S0}_${E}_${r}_${sigma}_${T}_${N}_${thread}
      #SBATCH -N 1
      ...
      cd $HOME/parcompfin
      make mc_amer
      ./bin/mc_amer_omp ${payoff_fun} ${S0} ${E} ${r} ${sigma} ${T} ${N} ${M} ${thread} >> ${results}" > parcomfin.sbatch
        # sbatch parcomfin.sbatch && wait
      ...
      do
        ...
        echo "#!/bin/bash
      #SBATCH -J MC_AMER_MPI_${payoff_fun}_${S0}_${E}_${r}_${sigma}_${T}_${N}_${p}
      #SBATCH -N ${p}
      #SBATCH --ntasks-per-node=1
      #SBATCH --mem=2048
      #SBATCH -t 00:10:00
      ...
      cd $HOME/parcompfin
      make mc_amer
      mpirun -n $p --hostfile hostfile ./bin/mc_amer_mpi ${payoff_fun} ${S0} ${E} ${r} ${sigma} ${T} ${N} ${M} >> ${results}" > parcomfin.sbatch
        # sbatch parcomfin.sbatch && wait
        ...
        then
            echo "#!/bin/bash
          #SBATCH -J MC_AMER_HYBRID_${payoff_fun}_${S0}_${E}_${r}_${sigma}_${T}_${N}_${p}_${thread}
          #SBATCH -N 1
          #SBATCH --ntasks-per-node=1
          #SBATCH --mem=2048
          #SBATCH -t 00:10:00
          ...
          cd $HOME/parcompfin
          make mc_amer
          mpirun -n $p --hostfile hostfile ./bin/mc_amer_hybrid ${payoff_fun} ${S0} ${E} ${r} ${sigma} ${T} ${N} ${M} $thread >> ${results}" > parcomfin.sbatch
        # sbatch parcomfin.sbatch && wait
        elif [ ${p} -le 8 ];
        then
